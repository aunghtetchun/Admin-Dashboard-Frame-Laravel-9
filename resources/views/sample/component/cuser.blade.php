    ...
    @section('content')
        <section class="section">
            ...
            "Sample" => route("sample"),
                ...
                @slot('menu')Sample @endslot
                @slot("last") User @endslot
            @endcomponent
            {{--        breadcump sample --}}
                                    ...
                                    <div>
                                        <div class="user-item">
                                            ...
                                            <div class="user-details">
                                                <div class="user-name">Susie Willis</div>
                    ...
                    <div class="col-12 col-sm-12 col-lg-5">
                        <div class="card profile-widget">
                            ...
                            <div class="profile-widget-description pb-0">
                                <div class="profile-widget-name">Susie Willis <div class="text-muted d-inline font-weight-normal"><div class="slash"></div> Web Developer</div></div>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                                    tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
                                    quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
                                    consequat.</p>
                            ...
                            <div class="card-body">
                                <ul class="list-unstyled user-progress list-unstyled-border list-unstyled-noborder">
                                    ...
                                    <li class="media">
                                        ...
                                        <div class="media-body">
                                            <div class="media-title">Marshall Nichols</div>
                                            <div class="text-job text-muted">Web Developer</div>
                                        </div>
                                        <div class="media-progressbar">
                                    ...
                                    <li class="media">
                                        ...
                                        <div class="media-body">
                                            <div class="media-title">Susie Willis</div>
                                            <div class="text-job text-muted">Web Developer</div>
                                        </div>
                                        <div class="media-progressbar">
