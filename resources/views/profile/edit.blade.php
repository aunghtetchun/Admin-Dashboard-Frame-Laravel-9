...
@section('content')
    ...
    @component("component.breadcrumb",["data"=>[]])
        @slot('menu')Profile Edit @endslot
        ...
        <div class="col-12 col-md-4">
            @component("component.card")
                ...
                @slot('body')
                    ...
                    <img src="{{ isset(Auth::user()->photo) ? asset('storage/profile/'.Auth::user()->photo) : asset('images/default_profile.jpg') }}" class="d-block w-50 mx-auto rounded-circle my-3" alt="">
                    ...
                    <form action="{{ route('profile.changePhoto') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="d-flex justify-content-between align-items-end">
                            ...
                            <button type="submit" class="btn btn-primary py-2 ml-1  text-center">
...
{{--                    <img src="{{ asset("/dashboard/css/main_bg.jpg") }}" class="d-block w-100 mx-auto" alt="">--}}
